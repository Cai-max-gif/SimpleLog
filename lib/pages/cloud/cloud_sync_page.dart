            ...
            child: authAsync.when(
              ...
              data: (auth) => FutureBuilder<CloudUser?>(
                ...
                builder: (ctx, snap) {
                  ...
                  final canUseCloud =
                      !isLocalMode && (!isSupabaseMode || user != null);
                              ...
                              children: [
                                ...
                                AppListTile(
                                  ...
                                  onTap: () async {
                                    ...
                                    ref
                                        .read(
                                            uploadingLedgerIdsProvider.notifier)
                                ...
                                AppListTile(
                                  ...
                                  onTap: () async {
                                    ...
                                    try {
                                      ...
                                      if (syncManager != null) {
                                        final previewResult = await syncManager
                                            .downloadAndPreview(
                                          ledgerId: ledgerId,
                                        );
                                ...
                                if (!isLocalMode)
                                  Consumer(builder: (ctx, r, _) {
                                    final multiDevice =
                                        r.watch(multiDeviceSyncProvider);
                                    final setter =
                                        r.read(multiDeviceSyncSetterProvider);
                                    final value =
                                        multiDevice.asData?.value ?? false;
                                    final can = canUseCloud;
